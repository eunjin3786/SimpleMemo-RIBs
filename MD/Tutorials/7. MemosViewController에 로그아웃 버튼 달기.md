...
<details>
<summary>1.  LoggedInRouter한테 MemoRIB을 detach하라고 명령하기</summary><br/>
```swift 
...
<details>
<summary>2. 부모 RIB(= Root RIB)의 인터랙터에게 자신을 detach하라고 알려주기</summary><br/>
```swift 
...
만약 로그인립이 있다면 detach해줘야하므로 아래와 같이 수정해줍니다.   
