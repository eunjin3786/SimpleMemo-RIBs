...
이 뷰컨트롤러를 듣고 있는 것(listener)은 인터랙터입니다.

LoggedOutPresentableListener프로토콜을 LoggedOutInteractor가 따르고 있어서, 

LoggedOutInteractor에서 loginDidTap을 구현해줘야합니다. 
...
인터랙터에도 listener가 있는데요, 이 인터랙터를 듣고 있는 것은 바로 부모 인터랙터(RootInteractor) 입니다. RootInteractable이 LoggedOutListener프토토콜을 따르고 있기 때문입니다.
